...
ExportIn is a Chrome extension published by tonoïd. It exports your LinkedIn connections and Facebook friends, with their birthdays and contact details, to files on your computer.

## What the extension reads

When you press Start or Sync, ExportIn reads, from your own LinkedIn and Facebook sessions:
...
ExportIn has no server. It sends nothing to tonoïd or anyone else: no analytics, no telemetry, no crash reporting, no AI service. The only sites it contacts are `linkedin.com`, `media.licdn.com`, `facebook.com` and `fbcdn.net`, with your own session.
...
- **Reset everything**, at the top of the panel, deletes both networks, the photos and the settings.
